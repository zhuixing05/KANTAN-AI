      ...
      case 'general':
        return (
          <div className="space-y-8">
            ...
            <div>
              <h4 className="text-sm font-medium mb-3" style={{ color: 'var(--kantan-text-primary)' }}>
                ...
                {(['light', 'dark', 'system'] as const).map((mode) => {
                  ...
                  return (
                    <button
                      ...
                      style={{
                        borderColor: isSelected ? 'var(--kantan-primary)' : 'var(--kantan-border)',
                        backgroundColor: isSelected ? 'var(--kantan-primary-muted)' : undefined,
                      }}
                    >
                      ...
                      <span className="text-xs font-medium" style={{ color: isSelected ? 'var(--kantan-primary)' : 'var(--kantan-text-primary)' }}>
                        {i18nService.t(mode)}
                      </span>
                    </button>
                  );
              ...
              <h4 className="text-sm font-medium mb-3 mt-5" style={{ color: 'var(--kantan-text-primary)' }}>
                ...
                const renderTile = (t: import('../theme').ThemeDefinition) => {
                  ...
                  return (
                    <button
                      ...
                      style={{
                        borderColor: isSelected ? 'var(--kantan-primary)' : undefined,
                        backgroundColor: isSelected ? 'var(--kantan-primary-muted)' : undefined,
                      }}
                    >
                      ...
                      <span className="text-[10px] font-medium truncate w-full text-center" style={{ color: isSelected ? 'var(--kantan-primary)' : 'var(--kantan-text-primary)' }}>
                        {t.meta.name}
                      </span>
                    </button>
                  );
      ...
      case 'about':
        return (
          <div className="flex min-h-full flex-col items-center pt-6 pb-3">
            {/* Logo & App Name */}
            <img
              src={testModeUnlocked ? 'logo-without-background.png' : 'logo.png'}
              alt="KANTAN AI"
            ...
            />
            <h3 className="text-lg font-semibold text-foreground">KANTAN AI</h3>
