...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    authQuotaExhausted: '今日免费额度已用完。您可以登录 KANTAN AI Portal 购买套餐或积分包继续使用，或在设置中配置自己的 API Key。',
    authTopUpLink: '充值',
    authSettingsLink: '设置',
    ...
    coworkWorkingDirectoryHint: 'KANTAN AI 将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为 KANTAN AI 设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义 KANTAN AI 的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: 'KANTAN AI 使用模型设置中的当前模型与提供商配置。',
    ...
    coworkConfigSaveFailed: '保存 KANTAN AI 配置失败，请稍后重试。',
    ...
    coworkPermissionDescription: 'KANTAN AI 请求执行以下操作',
    coworkSelectionRequired: '请选择',
    coworkSelectionDescription: 'KANTAN AI 需要你做出选择',
    coworkToolName: '工具名称',
    ...
    // 隐私协议弹窗
    privacyDialogTitle: '网易有道KANTAN AI服务协议',
    privacyDialogDesc: '在使用网易有道KANTAN AI之前，请您仔细阅读{link}内容，并进行确认。',
    privacyDialogLinkText: '网易有道KANTAN AI服务协议',
  ...
  en: {
    ...
    authQuotaExhausted: 'Daily free quota exhausted. Visit KANTAN AI Portal to purchase a plan or credits, or configure your own API Key in Settings.',
    ...
    // KANTAN AI
    cowork: 'KANTAN AI',
    coworkSettings: 'KANTAN AI Settings',
    ...
    coworkWorkingDirectoryHint: 'KANTAN AI will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for KANTAN AI...',
    coworkSystemPromptHint: 'Optional system prompt to customize KANTAN AI\'s behavior',
    ...
    coworkModelSettingsHint: 'KANTAN AI uses the current model and provider configuration from Model Settings.',
    ...
    coworkConfigSaveFailed: 'Failed to save KANTAN AI settings. Please try again.',
    ...
    coworkPermissionDescription: 'KANTAN AI is requesting to perform the following action',
    coworkSelectionRequired: 'Please Choose',
    coworkSelectionDescription: 'KANTAN AI needs your input',
    ...
    // Security scan
    kantanGuardEnabled: 'Security Active',
    ...
    // Privacy dialog
    privacyDialogTitle: 'NetEase Youdao KANTAN AI Terms of Service',
    privacyDialogDesc: 'Before using NetEase Youdao KANTAN AI, please carefully read the {link} and confirm.',
    privacyDialogLinkText: 'NetEase Youdao KANTAN AI Terms of Service',
