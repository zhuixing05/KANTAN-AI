...
###############################################################################
# 功能说明：
# 1. 自动修复 electron-builder.json 配置文件格式问题
# 2. 检查并安装必要的编译工具（build-essential, python3等）
# 3. 清理旧的构建文件和依赖
# 4. 重新安装项目依赖
# 5. 执行 Linux deb 包打包
###############################################################################
...
###############################################################################
echo "[步骤 1/5] 修复 electron-builder.json 配置文件..."
echo "-----------------------------------------------------------------------------"
